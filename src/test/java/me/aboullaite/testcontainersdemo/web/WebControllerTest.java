...
class WebControllerTest extends AbstractIntegrationTest {
  ...
  void shouldDisplayHomePageWithProducts() throws Exception {
    ...
    Product product = Product.builder()
        ...
        .description("A product for testing the web layer")
    ...
    mockMvc.perform(get("/"))
        ...
        .andExpect(content().string(containsString("Test Web Product")))
  ...
  void shouldCreateNewProduct() throws Exception {
    ...
    await().atMost(2, TimeUnit.SECONDS).untilAsserted(() -> {
      assertThat(productService.findAll()
          .stream()
          .anyMatch(p -> p.getName().equals("New Web Product"))).isTrue();
    });
  }
  ...
  void shouldUpdateStockViaKafka() throws Exception {
    ...
    Product product = Product.builder()
        .name("Kafka Web Test")
        .description("Testing Kafka integration via web")
